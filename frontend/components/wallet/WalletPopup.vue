    ...
    <div class="flex flex-col gap-4">
        ...
        <TextBlock v-if="isExplanationsShown" title="What is VAT?">
            ...
            <a
                ...
                >The VAT itself</a
            >
            is the set of immutable rules for managing DAI and collaterals which constitutes the core of the MakerDAO.
        </TextBlock>
...
export default Vue.extend({
    name: 'WalletPopup',
    components: { TextBlock, WalletDepositWithdrawBlock, WalletTable },
    props: {
        walletAddress: {
            type: String,
            default: null,
