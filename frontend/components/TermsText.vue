<template>
    <div class="flex flex-col space-y-8 py-8">
        <TextBlock class="TextBlock">
            <h1 class="HeaderText">Terms and Conditions</h1>
            <p class="italic">Last updated: November 04, 2021</p>
            Please read these terms and conditions carefully before using Our Service.
            <h1 class="HeaderText">Interpretation and Definitions</h1>
            <h2 class="SubHeaderText">Interpretation</h2>
            The words of which the initial letter is capitalized have meanings defined under the following conditions.
            The following definitions shall have the same meaning regardless of whether they appear in singular or in
            plural.
            <h2 class="SubHeaderText">Definitions</h2>
            For the purposes of these Terms and Conditions:

            <ul class="list-disc list-inside ml-4">
                <li>
                    <span class="font-bold">Affiliate</span> means an entity that controls, is controlled by or is
                ...
                <li><span class="font-bold">Country</span> refers to: Nordrhein-Westfalen, Germany</li>
                <li>
                    <span class="font-bold">Company</span> (referred to as either "the Company", "We", "Us" or "Our" in
                    this Agreement) refers to SIDESTREAM GmbH, Ottostr. 72 50823 Köln.
                </li>
                <li>
                    <span class="font-bold">Device</span> means any device that can access the Service such as a
                    computer, a cellphone or a digital tablet.
                </li>
                <li><span class="font-bold">Service</span> refers to the Website.</li>
                <li>
                    <span class="font-bold">Terms and Conditions</span> (also referred as "Terms") mean these Terms and
                ...
                <li>
                    <span class="font-bold">Third-party Social Media Service</span> means any services or content
                ...
                <li>
                    <span class="font-bold">Website</span> refers to Auctions UI, accessible from
                    https://auctions.makerdao.network/
                </li>
                <li>
                    <span class="font-bold">You</span> means the individual accessing or using the Service, or the
        ...
        <TextBlock class="TextBlock">
            <h1 class="HeaderText">Acknowledgment</h1>
        ...
        <TextBlock class="TextBlock">
            <h1 class="HeaderText">Links to Other Websites</h1>
        ...
        <TextBlock class="TextBlock">
            <h1 class="HeaderText">Termination</h1>
        ...
        <TextBlock class="TextBlock">
            <h1 class="HeaderText">Limitation of Liability</h1>
        ...
        <TextBlock class="TextBlock">
            <h1 class="HeaderText">"AS IS" and "AS AVAILABLE" Disclaimer</h1>
        ...
        <TextBlock class="TextBlock">
            <h1 class="HeaderText">Governing Law</h1>
        ...
        <TextBlock class="TextBlock">
            <h1 class="HeaderText">Disputes Resolution</h1>
        ...
        <TextBlock class="TextBlock">
            <h1 class="HeaderText">For European Union (EU) Users</h1>
        ...
        <TextBlock class="TextBlock">
            <h1 class="HeaderText">United States Legal Compliance</h1>
        ...
        <TextBlock class="TextBlock">
            <h1 class="HeaderText">Severability and Waiver</h1>
            <h2 class="SubHeaderText">Severability</h2>
            ...
            <h2 class="SubHeaderText">Waiver</h2>
        ...
        <TextBlock class="TextBlock">
            <h1 class="HeaderText">Translation Interpretation</h1>
            These Terms and Conditions may have been translated if We have made them available to You on our Service.
            You agree that the original English text shall prevail in the case of a dispute.
        </TextBlock>
        <TextBlock class="TextBlock">
            <h1 class="HeaderText">Changes to These Terms and Conditions</h1>
        ...
        <TextBlock v-if="contactEmail" class="TextBlock">
            <h1 class="HeaderText">Contact Us</h1>
            If you have any questions about these Terms and Conditions, You can contact us:
            <ul class="list-disc list-inside ml-4">
                <li>
                    By email: <a :href="`mailto:${contactEmail}`" target="_blank">{{ contactEmail }}</a>
                </li>
            </ul>
        </TextBlock>
    </div>
...
<style scoped>
.TextBlock {
    @apply w-11/12 lg:w-5/12 mx-auto;
}

.HeaderText {
    @apply text-3xl font-extrabold my-3 text-gray-700 dark:text-gray-200;
}

.SubHeaderText {
    @apply text-xl font-semibold mb-1 text-gray-700 dark:text-gray-200 my-2;
}
</style>
