...
- `IS_STAGING_ENVIRONMENT`: (optional) When enabled a banner will warn users that they are currently viewing the staging environment, which may be unstable to use.
