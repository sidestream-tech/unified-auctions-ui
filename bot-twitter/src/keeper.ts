...
import { swapTheAuction, enrichAuction } from 'auctions-core/src/auctions';
import {
    authorizeCollateral,
    authorizeWallet,
...
const checkAndParticipateIfPossible = async function (auction: AuctionInitialInfo) {
    ...
    const bidHash = await swapTheAuction(ETHEREUM_NETWORK, auctionTransaction, walletAddress);
